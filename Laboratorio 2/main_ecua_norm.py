from ecuaciones_normales import ecua_norm
...
def main():
    ...
    #Graficar
    x1 = [x[0] for x in data_en] #tiempos datos de entrenamiento
    y1 = [x[1] for x in data_en] #ys datos de entrenamiento

    data_val.pop() #para evitar extrapolacion
    x2 = [x[0] for x in data_val] #tiempos datos de validacion
    y2 = [x[1] for x in data_val] #ys datos de validacion
    ...
    plt.title("Metodo ecuaciones normales")
    plt.legend()
    plt.grid()
